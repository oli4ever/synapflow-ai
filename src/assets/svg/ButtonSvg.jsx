const ButtonSvg = (cyan) => (
  <>
    ...
    >
      <path
        fill={cyan ? "#008B8B" : "none"}
        stroke={cyan ? "#008B8B" : "url(#btn-left)"}
        strokeWidth="2"
    ...
    >
      {cyan ? (
        ...
        <>
          <polygon
            fill="url(#btn-top)" // References gradient
            fillRule="nonzero"
            points="100 42 100 44 0 44 0 42"
          />
          <polygon
            fill="url(#btn-bottom)" // References gradient
            fillRule="nonzero"
    ...
    >
      <path
        fill={cyan ? "#008B8B" : "none"}
        stroke={cyan ? "#008B8B" : "url(#btn-right)"} // References gradient
        strokeWidth="2"
